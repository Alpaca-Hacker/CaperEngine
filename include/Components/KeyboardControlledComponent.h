...
struct KeyboardControlledComponent
{
	...
	KeyboardControlledComponent(glm::vec2 up_velocity = glm::vec2(0), glm::vec2 right_velocity = glm::vec2(0), 
		glm::vec2 down_velocity = glm::vec2(0), glm::vec2 left_velocity = glm::vec2(0))
